        ...
        <div className="relative flex items-center justify-center">
          ...
          >
            ...
            {(totalDhikrCount > 0 || duroodCount > 0) && (
              <span className="absolute -top-1 -right-1 flex h-6 w-6 items-center justify-center rounded-full bg-[#D4AF37] text-[#1B1214] text-[8px] font-bold z-20 border-2 border-[#F3D797]">
