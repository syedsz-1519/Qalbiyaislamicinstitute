...
export const Homepage: React.FC<HomepageProps> = ({ 
  ...
  const testimonies = [
    ...
    {
      quote: "I really loved the class, and my son is very happy too. Mustara Ma'am has such a lovely voice and a wonderful way of teaching, she keeps the children fully engaged throughout the class. My son tells me he really enjoys the classes and says he wants to study every day.",
    ...
    <div className="min-h-screen bg-[#FAF8F5] text-[#23181A] transition-colors duration-300 pb-16">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-24 pb-16 sm:pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6">
          ...
          >
            <h1 className="serif-heading text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#23181A] leading-[1.15] tracking-tight">
